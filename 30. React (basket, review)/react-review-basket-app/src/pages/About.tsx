      ...
      <section>
        ...
        <div className="mx-auto w-full max-w-7xl px-5 py-12 md:px-6 md:py-12">
          ...
          <div className="flex flex-col gap-4 md:flex-row md:gap-6">
            ...
            <div className="flex flex-col gap-8 md:w-3/5">
              ...
              <div className="grid gap-8 md:grid-cols-2 md:gap-4">
                <div className="flex flex-col gap-4 rounded-md border border-solid bg-gray-100 p-6 md:p-4">
                  ...
                  <div className="flex md:flex-row flex-col items-center gap-2 sm:gap-x-4">
                    ...
                    {/* Divider */}{" "}
                    <div className="h-5 w-px hidden md:inline-flex bg-gray-300"></div>
                    <div className="flex items-center gap-x-2">
            ...
            {/* Image */}
            <div className="w-full rounded-md bg-gray-100 max-[991px]:h-[475px] md:w-2/5"></div>
          </div>
        </div>
      </section>
    </>
